...
class HRNet(nn.Module):
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        hrnet = timm.create_model('hrnet_w30', pretrained=True)
        hrnet.global_pool = GeneralizedMeanPoolingP(3)
        hrnet.classifier = nn.Sequential()
