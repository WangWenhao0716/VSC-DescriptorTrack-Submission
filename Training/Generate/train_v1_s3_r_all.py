...
path_1 = '/raid/VSC/data/training_images_ref1/'
path_2 = '/raid/VSC/images/train_v1_s3_r1_all/train_v1_s3_r1_all/'
...
num = args.num
begin = num * (len(names)//200 + 1)
end = (num+1) * (len(names)//200 + 1)
