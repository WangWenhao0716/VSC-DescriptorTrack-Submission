...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50_double', 'resnet101',
           'resnet152']
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        if not self.cut_at_pooling:
            ...
            if self.num_classes > 0:
                ...
                self.classifier_small = build_metric('cos', 2048, self.num_classes_small, s=64, m=0.35).cuda()
