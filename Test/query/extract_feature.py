...
import numpy as np
from models_isc.gem import GeneralizedMeanPoolingP
import sys
import os
import pdb
import argparse
...
def main():
    ...
    aa('--batch_size', default=250, type=int, help="max batch size to use for extraction")
    ...
    image_list = [image_dir + '/' + name for name in namess]
