...
from dg.trainers_cos_ema_tune import Trainer
...
def main_worker(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        trainer.train(epoch, train_loader, support_loader, optimizer, ema, train_iters=len(train_loader), print_freq=args.print_freq) 
        lr_scheduler.step()
        is_best = False
