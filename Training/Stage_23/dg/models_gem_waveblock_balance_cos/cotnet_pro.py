...
class Cotnet_pro(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
                 ...
                 dev = None):
        super(Cotnet_pro, self).__init__()
        ...
        print("Loading the supervised cotnet pre-trained model")
        pretrained_net_dict = torch.load('cotnet50.pth.tar', map_location='cpu')
        cotnet.load_state_dict(pretrained_net_dict)
...
def cotnet50_pro(**kwargs):
    return Cotnet_pro(50, **kwargs)
